...
\item %b
Let $T\prs{n} = 3T\prs{n/3} + n/\log n$. Let $a = 3, b = 3, f\prs{n} = n/\log n$ and $g\prs{n} = n^{\log_b a} = n$. Hence $f\prs{n} = \Theta\prs{g\prs{n} / \log n}$, and by \Cref{exercise:master-k-minus-1} we get that $T\prs{n} = \Theta\prs{g\prs{n} \log \log n} = \Theta\prs{n \log \log n}$.
\item %c
